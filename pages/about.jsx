    ...
    >
      <Box>
        {number && (
          <Typography
            variant="overline"
            sx={{ color: '#555', letterSpacing: '0.15em', display: 'block', mb: 0.5, fontWeight: 600, fontFamily: accentFont }}
          >
            {number}
          </Typography>
        )}
          ...
          <Container maxWidth="lg" sx={{ py: { xs: 5, md: 10 }, px: { xs: 2, md: 5 } }}>
            <Grid container spacing={{ xs: 2, md: 3 }} alignItems="flex-start">
              ...
              <Grid size={{ xs: 12, md: 7 }}>
                <Typography
                  variant="overline"
                  sx={{ color: '#555', letterSpacing: '0.15em', mb: { xs: 1.5, md: 2 }, display: 'block', fontWeight: 600, fontFamily: accentFont }}
                >
                  01 / About
                </Typography>
                <Typography
                ...
                <Box sx={{ border: '1px solid #E0E0E0', borderRadius: 'var(--radius-lg)', p: { xs: 2.5, md: 4 } }}>
                  ...
                  {about.metrics?.length > 0 && (
                    <Box>
                      <Typography
                        variant="overline"
                        sx={{ color: '#555', letterSpacing: '0.15em', mb: 1.5, display: 'block', fontWeight: 600, fontFamily: accentFont }}
                      >
                        At a glance
                      </Typography>
                      {about.metrics.map((m, i) => (
                        ...
                        >
                          <Typography variant="caption" sx={{ color: '#555', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600, fontFamily: accentFont }}>
                            {m.label}
                          </Typography>
                      ...
                      <Grid size={{ xs: 12, md: 4 }} key={skill.id}>
                        <Box sx={{
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                            ...
                            <Typography variant="caption" sx={{ color: '#555', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: accentFont }}>
                              {skill.level}
                            </Typography>
                          </Box>
                          <Box
