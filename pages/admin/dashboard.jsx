...
import HomeEditor from '../../src/admin/editors/HomeEditor';
import AboutEditor from '../../src/admin/editors/AboutEditor';
import ProjectsEditor from '../../src/admin/editors/ProjectsEditor';
import ContactEditor from '../../src/admin/editors/ContactEditor';
import SettingsEditor from '../../src/admin/editors/SettingsEditor';
import QuotesEditor from '../../src/admin/editors/QuotesEditor';
import { loadData, saveData } from '../../src/data/portfolioData';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const admin = sessionStorage.getItem('finfolio_admin') === 'true';
    if (!admin) {
      router.push('/admin');
      return;
    }
  ...
  if (!isAdmin || !data || !localData) return null;
  ...
  return (
    <>
      <Head>
        <title>Admin Dashboard | FinFolio</title>
      </Head>
